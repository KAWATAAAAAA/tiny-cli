...
var fetchTagList = function (repo) { return __awaiter(void 0, void 0, void 0, function () {
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                console.log(repo);
                return [4 /*yield*/, axios.get("https://api.github.com/repos/Tiny-CLI-Template/" + repo + "/tags")];
            case 1:
                data = (_a.sent()).data;
                return [2 /*return*/, data];
        }
...
// 3.封装执行函数时的loading效果
var waitFnloading = function (fn, message) { return function () {
    var args = [];
                            ...
                            return __generator(this, function (_a) {
                                switch (_a.label) {
                                    case 0:
                                        ...
                                        if (!content.includes('<%')) return [3 /*break*/, 2];
