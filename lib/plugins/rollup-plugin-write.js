...
var appVersion = require("" + path.resolve(process.cwd(), "package.json")).version;
var fs = require("fs");
var v = new Date();
                ...
                setImmediate(function () { return __awaiter(_this, void 0, void 0, function () {
                    return __generator(this, function (_a) {
                        fs.mkdir(filePath, { recursive: true }, function (err) {
                            !err && fs.writeFile(filePath + "/" + fileName, content, { flag: "a" }, function (err) {
                                if (err) {
                                    console.log(err);
                                }
                            });
...
//# sourceMappingURL=rollup-plugin-write.js.map